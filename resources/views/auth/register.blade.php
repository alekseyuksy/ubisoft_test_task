                ...
                <form class="form" method="POST" action="{{ route('register') }}">
                  ...
                  <span class="input-group-text">
                      <i class="material-icons">face</i>
                            ...
                            <div class="bmd-form-group{{ $errors->has('device') ? ' has-danger' : '' }} mt-3">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                  <span class="input-group-text">
                      <i class="material-icons">phone</i>
                                    ...
                                    <input type="text" name="device" class="form-control"
                                           placeholder="{{ __('Device...') }}" value="{{ old('device') }}" required>
                                </div>
                                @if ($errors->has('device'))
                                    <div id="device-error" class="error text-danger pl-3" for="device"
                                         style="display: block;">
                                        <strong>{{ $errors->first('device') }}</strong>
                                    </div>
                                @endif
                            </div>
                            <div class="bmd-form-group{{ $errors->has('region') ? ' has-danger' : '' }} mt-3">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                  <span class="input-group-text">
                      <i class="material-icons">face</i>
                                    ...
                                    <input type="text" name="region" class="form-control"
                                           placeholder="{{ __('Region...') }}" value="{{ old('region') }}" required>
                                </div>
                                @if ($errors->has('region'))
                                    <div id="region-error" class="error text-danger pl-3" for="region"
                                         style="display: block;">
